...
#https://github.com/Engine-Treasure/awesome-python3-webapp/blob/master/www/app.py
'web application骨架'
...
def init(loop):
	# 创建全局数据库连接池
	yield from orm.create_pool(loop = loop,host='127.0.0.1',port = 3306,user = 'root',password = 'password',db = 'mypython')
	#创建web应用
